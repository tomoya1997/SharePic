...
var routes = [{
  ...
  path: '*',
  // 任意* *で指定した場合、定義されていないパスで飛んできた場合、ここに飛ぶ様になる
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              response = _context4.sent;
              // ログイン時以外はnull nullで統一したいから
              user = response.data || null; // response.dataがtrueならそのまま、違うならnull
...
var OK = 200; // exportを指定すれば、外部からのアクセスが可能になる（public的な）
...
module.exports = __webpack_require__(/*! /Users/tomoya/sharePic/resources/js/app.js */"./resources/js/app.js");
